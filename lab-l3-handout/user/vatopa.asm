...
int main(int argc, char *argv[])
{
  ...
  if (argc > 3) {
   a:	478d                	li	a5,3
   c:	02a7c163          	blt	a5,a0,2e <main+0x2e>
  10:	84ae                	mv	s1,a1
  ...
  if (argc == 3){
  12:	478d                	li	a5,3
  14:	02f50a63          	beq	a0,a5,48 <main+0x48>
    va2pa((uint64)argv[1], (uint64)argv[2]);
  }
  if (argc == 2) {
  18:	4789                	li	a5,2
  1a:	02f50e63          	beq	a0,a5,56 <main+0x56>
    printf("va from main: %s", (uint64)argv[1]);
    va2pa((uint64)argv[1], getpid());
  }
  if (argc == 1) {
  1e:	4785                	li	a5,1
  20:	06f50063          	beq	a0,a5,80 <main+0x80>
    va2pa(0, getpid());
  }
    exit(0);
  24:	4501                	li	a0,0
  26:	00000097          	auipc	ra,0x0
  2a:	2f6080e7          	jalr	758(ra) # 31c <exit>
    printf("Usage: vatopa [virtual address] [pid]\n");
  2e:	00001517          	auipc	a0,0x1
  32:	83250513          	addi	a0,a0,-1998 # 860 <malloc+0xea>
  36:	00000097          	auipc	ra,0x0
  3a:	688080e7          	jalr	1672(ra) # 6be <printf>
    exit(1);
  3e:	4505                	li	a0,1
  ...
  50:	388080e7          	jalr	904(ra) # 3d4 <va2pa>
  if (argc == 1) {
  54:	bfc1                	j	24 <main+0x24>
    printf("va from main: %s", (uint64)argv[1]);
  56:	658c                	ld	a1,8(a1)
  58:	00001517          	auipc	a0,0x1
  5c:	83050513          	addi	a0,a0,-2000 # 888 <malloc+0x112>
  60:	00000097          	auipc	ra,0x0
  64:	65e080e7          	jalr	1630(ra) # 6be <printf>
    va2pa((uint64)argv[1], getpid());
  68:	6484                	ld	s1,8(s1)
  6a:	00000097          	auipc	ra,0x0
  6e:	332080e7          	jalr	818(ra) # 39c <getpid>
  72:	85aa                	mv	a1,a0
  74:	8526                	mv	a0,s1
  76:	00000097          	auipc	ra,0x0
  7a:	35e080e7          	jalr	862(ra) # 3d4 <va2pa>
  if (argc == 1) {
  7e:	b75d                	j	24 <main+0x24>
    va2pa(0, getpid());
  80:	00000097          	auipc	ra,0x0
  84:	31c080e7          	jalr	796(ra) # 39c <getpid>
  88:	85aa                	mv	a1,a0
  8a:	4501                	li	a0,0
  8c:	00000097          	auipc	ra,0x0
  90:	348080e7          	jalr	840(ra) # 3d4 <va2pa>
  94:	bf41                	j	24 <main+0x24>
